...
INSERT INTO users (id, email, password_hash, role) VALUES
    ('11111111-1111-1111-1111-111111111111', 'moderator@example.com', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'moderator'),
    ('22222222-2222-2222-2222-222222222222', 'employee1@example.com', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'employee'),
    ('33333333-3333-3333-3333-333333333333', 'employee2@example.com', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'employee');

-- Пароль для всех: '123456' (хеш bcrypt)
...
INSERT INTO receptions (id, date_time, pvz_id, status) VALUES
    ...
    ('99999999-9999-9999-9999-999999999999', '2023-03-03 15:00:00', '66666666-6666-6666-6666-666666666666', 'close');
...
INSERT INTO products (id, date_time, type, reception_id) VALUES
    ...
    ('dddddddd-dddd-dddd-dddd-dddddddddddd', '2023-03-03 15:10:00', 'электроника', '99999999-9999-9999-9999-999999999999');
